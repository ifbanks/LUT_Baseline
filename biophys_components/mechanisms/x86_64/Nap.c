...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nap /home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/x86_64/Nap.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
   ...
   if ( _lv < - 23.0 ) {
     mtau = 100.0 * ( 0.025 + 0.14 * exp ( ( _lv + 23.0 ) / 10.0 ) ) ;
     }
   else {
     mtau = 100.0 * ( 0.02 + 0.145 * exp ( ( - _lv - 23.0 ) / 10.0 ) ) ;
     }
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/Nap.mod";
static const char* nmodl_file_text = 
  ...
  "	}\n"
  "	if( v < -23 ) { :-40\n"
  "		mtau = 100*(0.025 + 0.14 * exp( ( v + 23 ) / 10 ))\n"
  "	}else{\n"
  "		mtau = 100*(0.02 + 0.145 * exp( ( - v - 23 ) / 10 ))\n"
  "	}\n"
  "}\n"
  "UNITSON\n"
  ;
