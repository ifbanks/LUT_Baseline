...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kap /home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/x86_64/kaprox.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lqt = pow( q10 , ( ( celsius - 24.0 ) / 10.0 ) ) ;
   ...
   linf = 1.0 / ( 1.0 + exp ( ( - _lv - 34.0 ) / ( - 8.738 ) ) ) ;
   taul = 0.26 * ( _lv + 28.0 ) / qtl ;
   if ( taul < lmin / qtl ) {
     taul = lmin / qtl ;
     }
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/kaprox.mod";
static const char* nmodl_file_text = 
  ...
  "        a = alpl(v)\n"
  "		linf = 1 / ( 1 + exp( ( - v - 34 ) / (-8.738) ) ) ::56\n"
  "	taul = 0.26*(v+28)/qtl ::50\n"
