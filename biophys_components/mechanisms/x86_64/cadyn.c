...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cadyn /home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/x86_64/cadyn.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
    if ( _lv < - 35.5 ) {
     ...
     uinf = 1.0 / ( exp ( - ( _lv + 8.0 ) / 11.0 ) + 1.0 ) ;
     }
   utau = 1.25 * 2.0 / ( exp ( - 0.031 * ( _lv + 15.1 ) ) + exp ( 0.031 * ( _lv + 15.1 ) ) ) ;
   zinf = 1.0 / ( exp ( ( _lv - 9.4 ) / 18.9 ) + 1.0 ) ;
   ztau = 420.0 ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/cadyn.mod";
static const char* nmodl_file_text = 
  ...
  "	uinf = 0\n"
  "	} else{\n"
  "	uinf = 1/(exp(-(v+8)/11)+1)      ::::::::::::::::: 30\n"
  "	}\n"
  "	utau = 1.25*2/(exp(-0.031*(v+15.1)) + exp(0.031*(v+15.1))) :::::37.1\n"
  "\n"
  "	zinf = 1/(exp((v-9.4)/18.9)+1) ::+12.6\n"
  "	ztau = 420	\n"
  "	UNITSON	\n"
  "}\n"
  ;
