...
#define nrn_init _nrn_init__NetStimNEWh
#define _nrn_initial _nrn_initial__NetStimNEWh
#define nrn_cur _nrn_cur__NetStimNEWh
#define _nrn_current _nrn_current__NetStimNEWh
#define nrn_jacob _nrn_jacob__NetStimNEWh
#define nrn_state _nrn_state__NetStimNEWh
#define _net_receive _net_receive__NetStimNEWh 
#define init_sequence init_sequence__NetStimNEWh 
#define next_invl next_invl__NetStimNEWh 
#define noiseFromRandom noiseFromRandom__NetStimNEWh 
#define seed seed__NetStimNEWh 
...
#define erand erand_NetStimNEWh
#define invl invl_NetStimNEWh
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NetStimNEWh /home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/x86_64/netstimNEWh.mod\n");
...
static int  next_invl ( _threadargsprotocomma_ double _lt ) {
   if ( number > 0.0 ) {
     event = invl ( _threadargscomma_ interval - 1.45833e-4 * _lt ) ;
     }
   if ( ispike >= number ) {
     on = 0.0 ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/netstimNEWh.mod";
static const char* nmodl_file_text = 
  ": $Id: netstim.mod 2212 2008-09-08 14:32:26Z hines $\n"
  ": comments at end\n"
  "\n"
  "NEURON	{ \n"
  "  ARTIFICIAL_CELL NetStimNEWh\n"
  ...
  "	if (number > 0) {\n"
  "		event = invl(interval-1.45833e-4*t) :CHANGED(10-80 Hz, i.e., 100 to 12.5 ms, in 100 min)\n"
  "	}\n"
  "	if (ispike >= number) {\n"
  "		on = 0\n"
  "	}\n"
