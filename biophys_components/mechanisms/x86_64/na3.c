...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na3 /home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/x86_64/na3.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/na3.mod";
static const char* nmodl_file_text = 
  "TITLE na3\n"
  ": Na current \n"
  ": from Jeff M.\n"
  ...
  "	gbar = 0.010   	(mho/cm2)	\n"
  "								\n"
  "	tha  =  -8	(mV) : -30		: v 1/2 for act	\n"
  "	qa   = 7.2	(mV)			: act slope (4.5)		\n"
  "	Ra   = 0.4	(/ms)			: open (v)		\n"
  "	Rb   = 0.124 	(/ms)		: close (v)		\n"
  "\n"
  "	thi1  = -23	(mV) :-45		: v 1/2 for inact 	\n"
  "	thi2  = -23 	(mV) :45	: v 1/2 for inact 	\n"
  ...
  "	tq   = -55      (mV)\n"
  "\n"
  "	thinf  = -38 	(mV) :-54	: inact inf slope	\n"
  ...
  "	minf = 0\n"
  "	} else{\n"
  "	minf  = 1 / ( 1 + exp( ( - v - 16.43 ) / 7.2 ) ) : 38.43\n"
  "	}\n"
