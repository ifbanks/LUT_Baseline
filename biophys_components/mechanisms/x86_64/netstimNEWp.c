...
#define nrn_init _nrn_init__NetStimNEWp
#define _nrn_initial _nrn_initial__NetStimNEWp
#define nrn_cur _nrn_cur__NetStimNEWp
#define _nrn_current _nrn_current__NetStimNEWp
#define nrn_jacob _nrn_jacob__NetStimNEWp
#define nrn_state _nrn_state__NetStimNEWp
#define _net_receive _net_receive__NetStimNEWp 
#define init_sequence init_sequence__NetStimNEWp 
#define next_invl next_invl__NetStimNEWp 
#define noiseFromRandom noiseFromRandom__NetStimNEWp 
#define seed seed__NetStimNEWp 
...
#define erand erand_NetStimNEWp
#define invl invl_NetStimNEWp
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NetStimNEWp /home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/x86_64/netstimNEWp.mod\n");
...
static int  next_invl ( _threadargsprotocomma_ double _lt ) {
   if ( number > 0.0 ) {
     event = invl ( _threadargscomma_ interval - 1.6458e-3 * _lt ) ;
     }
   if ( ispike >= number ) {
     on = 0.0 ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ifbdtk/LUT_SCI_Hunter/LUT_Baseline/biophys_components/mechanisms/modfiles/netstimNEWp.mod";
static const char* nmodl_file_text = 
  ": $Id: netstim.mod 2212 2008-09-08 14:32:26Z hines $\n"
  ": comments at end\n"
  "\n"
  "NEURON	{ \n"
  "  ARTIFICIAL_CELL NetStimNEWp\n"
  ...
  "	if (number > 0) {\n"
  "		event = invl(interval-1.6458e-3*t) :CHANGED(1-80 Hz, i.e., 1000 to 12.5 ms, in 100 min)\n"
  "	}\n"
  "	if (ispike >= number) {\n"
  "		on = 0\n"
  "	}\n"
